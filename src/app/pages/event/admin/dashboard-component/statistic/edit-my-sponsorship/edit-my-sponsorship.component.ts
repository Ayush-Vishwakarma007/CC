...
@Component({
  selector: 'app-edit-my-sponsorship',
  templateUrl: './edit-my-sponsorship.component.html',
  styleUrls: ['./edit-my-sponsorship.component.scss']
})
export class EditMySponsorshipComponent implements OnInit {
    ...
    if (this.addSponsorForm.valid) {
      ...
      this.apiService.post(data).subscribe(response => {
        if (response['status']['code'] == 'CREATED' || response['status']['code'] == 'OK') {
          ...
          this.isSubmit = false;
          this.router.navigate(['event-dashboard/', this.eventId])
        } else {
