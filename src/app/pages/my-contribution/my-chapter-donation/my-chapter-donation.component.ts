...
@Component({
  selector: 'app-my-chapter-donation',
  templateUrl: './my-chapter-donation.component.html',
  styleUrls: ['./my-chapter-donation.component.scss']
})
export class MyChapterDonationComponent implements OnInit {
  @Input()
  userId = '';
  reqData: any = [];
  userList: any = [];
