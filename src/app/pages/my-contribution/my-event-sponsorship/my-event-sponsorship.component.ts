...
@Component({
  selector: 'app-my-event-sponsorship',
  templateUrl: './my-event-sponsorship.component.html',
  styleUrls: ['./my-event-sponsorship.component.scss']
})
export class MyEventSponsorshipComponent implements OnInit {
  ...
  constructor(public Http: HttpClient, public apiService: ApiService, public spinner: SpinnerService, private toastrService: ToastrService, private route: ActivatedRoute, public router: Router,public communityService: CommunityDetailsService) {
    this.reqData = {
      "filter": {
  ...
  editSponsorship(id){
    this.router.navigate(['/my-event-sponsorship/edit/',id]);
  }
