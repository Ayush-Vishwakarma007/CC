...
export class ContactUsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.communityService.communityDetail.location){
      /*this.center = {
        lat: this.communityService.communityDetail.location[0],
        lng:this.communityService.communityDetail.location[1],
      }
      this.markers.push({
        position: {
          lat:this.communityService.communityDetail.location[0],
        ...
        label: {
          color: 'red',
           text: this.communityService.communityDetail.basicInformation.name
        },
        title:this.communityService.communityDetail.basicInformation.name,
